...
public class Laptops implements Serializable{
	...
	public Laptops(String name,String image,String condition,double price,String manufacturer,double discount,String retailer,HashMap<String, Accessories> accessories,String id) {
		this.name = name;
		this.image = image;
