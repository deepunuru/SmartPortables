...
public class ManagerDisplayProducts extends HttpServlet{
	MySQLDataStoreUtilities dbObj;
	
	public ManagerDisplayProducts() {
		dbObj = new MySQLDataStoreUtilities();
	}
	
	public void printProduct(String op,String[] imgList,String[] priceList,String[] nameList,String[] idList,PrintWriter pWriter,int k,String type){
		switch(op) {
			case "updateProduct":{
			...
			case "deleteProduct":{
				pWriter.println("<img src='/csj/" + imgList[k] + "' style='width:150px;height:150px' alt='" + imgList[k] +"'>\n" +
						...
						"Price: $" + priceList[k] +"\n" +
						"<br />\n" +
						"<a id='deleteProductLink' href='/csj/Controller/ManagerHomeServlet?op=deleteProduct&id=" + idList[k] + "&type=" + type + "' method='get'>Delete Product</a></p>\n" +
						"<br />");
				break;
			}
			default :{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		...
		pWriter.println("<div id='body' class='width'>\n" +
				...
				"<form class='register' action='/csj/Controller/ManagerDisplayProducts?op=" + task + "' method='post'>\n" +
										...
										"<table id='SmartWatchList'>\n" +
											...
											"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
													for(int k=0;k<count;k++) {
														if(k%2 == 0) {
															printProduct(op,imgList,priceList,nameList,idList,pWriter,k,"smartwatches");
														}
													}
								pWriter.println("</td>\n" +
												"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
									...
									"<section id='content'>\n" +
										"<table id='SpeakerList'>\n" +
											...
											"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
													for(int k=0;k<count;k++) {
														if(k%2 == 0) {
															printProduct(op,imgList,priceList,nameList,idList,pWriter,k,"speakers");
														}
													}
								pWriter.println("</td>\n" +
												"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
									...
									"<section id='content'>\n" +
										"<table id='HeadphoneList'>\n" +
											...
											"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
													for(int k=0;k<count;k++) {
														if(k%2 == 0) {
															printProduct(op,imgList,priceList,nameList,idList,pWriter,k,"headphones");
														}
													}
								pWriter.println("</td>\n" +
												"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
									...
									"<section id='content'>\n" +
										"<table id='PhoneList'>\n" +
											...
											"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
													for(int k=0;k<count;k++) {
														if(k%2 == 0) {
															printProduct(op,imgList,priceList,nameList,idList,pWriter,k,"smartphones");
														}
													}
								pWriter.println("</td>\n" +
												"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
									...
									"<section id='content'>\n" +
										"<table id='LaptopList'>\n" +
											...
											"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
													for(int k=0;k<count;k++) {
														if(k%2 == 0) {
															printProduct(op,imgList,priceList,nameList,idList,pWriter,k,"laptops");
														}
													}
								pWriter.println("</td>\n" +
												"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
									...
									"<section id='content'>\n" +
										"<table id='StorageList'>\n" +
											...
											"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
													for(int k=0;k<count;k++) {
														if(k%2 == 0) {
															printProduct(op,imgList,priceList,nameList,idList,pWriter,k,"externalstorage");
														}
													}
								pWriter.println("</td>\n" +
												"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
									...
									"<section id='content'>\n" +
										"<table id='AccessoryList'>\n" +
											...
											"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
													for(int k=0;k<count;k++) {
														if(k%2 == 0) {
															printProduct(op,imgList,priceList,nameList,idList,pWriter,k,"accessories");
														}
													}
								pWriter.println("</td>\n" +
												"<td style='font-size:small;text-align:center;vertical-align: text-top;'>");
